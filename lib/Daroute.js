 ...
 * options:
 * - cache: boolean, string or function who return the hash to get the cache; if true
 *     the cache is register to request.url (all caches are depend of the encoding)
